...
if __name__ == '__main__':
    ...
    for size in sizes:
        ...
        cython_time = timeit.timeit('run_cython(envy_free_matching_name, G)')
        standard_time = timeit.timeit('run_standard(envy_free_matching_name, G)')
